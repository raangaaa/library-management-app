    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.NIS);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentNIS = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BookId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowBooks_Students_StudentNIS",
                        column: x => x.StudentNIS,
                        principalTable: "Students",
                        principalColumn: "NIS");
                    table.ForeignKey(
                        name: "FK_BorrowBooks_Users_UserModelUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowBooks_StudentNIS",
                table: "BorrowBooks",
                column: "StudentNIS");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowBooks_UserModelUserId",
                table: "BorrowBooks",
